...
#line 33 "lpc_chip_82x\\src\\stopwatch_8xx.c"
...
#line 34 "lpc_chip_82x\\src\\stopwatch_8xx.c"
...
{
	Chip_MRT_Init();
	Chip_MRT_SetMode(((LPC_MRT_CH_T *) &((LPC_MRT_T *) (0x40004000UL))->CHANNEL[1]), MRT_MODE_REPEAT);
	Chip_MRT_SetInterval(((LPC_MRT_CH_T *) &((LPC_MRT_T *) (0x40004000UL))->CHANNEL[1]), 0x7ffffff | (0x80000000UL));
	Chip_MRT_GetEnabled(((LPC_MRT_CH_T *) &((LPC_MRT_T *) (0x40004000UL))->CHANNEL[1]));
...
uint32_t StopWatch_Start(void)
{
	...
	return 0x7ffffff - Chip_MRT_GetTimer(((LPC_MRT_CH_T *) &((LPC_MRT_T *) (0x40004000UL))->CHANNEL[1]));
}
