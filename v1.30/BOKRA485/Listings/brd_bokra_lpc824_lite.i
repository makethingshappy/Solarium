...
#line 48 "..\\BOKRA485\\project.h"

#line 50 "..\\BOKRA485\\project.h"
...
#line 51 "..\\BOKRA485\\project.h"

#line 1 "..\\BOKRA485\\Hardware/brd_BOKRA_LPC824_Lite.h"
...
#line 9 "Hardware\\brd_BOKRA_LPC824_Lite.c"
...
{
	Chip_UART_Init(((LPC_USART_T *) (0x40064000UL)));												
	
	
	Chip_UART_ConfigData(((LPC_USART_T *) (0x40064000UL)), (0x00 << 4) | (0x01 << 2) | (0x00 << 6));	
	
	Chip_Clock_SetUSARTNBaseClockRate( 9600 * 8, 1);				

	Chip_UART_SetBaud (((LPC_USART_T *) (0x40064000UL)), 9600);						

	Chip_UART_TXEnable(((LPC_USART_T *) (0x40064000UL)));											
	Chip_UART_Enable(((LPC_USART_T *) (0x40064000UL)));												
}
...
void Board_I2C_Init (void)
{
	...
	Chip_I2C_Init(((LPC_I2C_T *) (0x40050000UL)));													

	CLKDiv = 1;																		
	do
	{	
		Chip_I2C_SetClockDiv(((LPC_I2C_T *) (0x40050000UL)), CLKDiv);								
		CLKDiv = Chip_I2C_GetClockDiv(((LPC_I2C_T *) (0x40050000UL)));								
		scl= Chip_Clock_GetSystemClockRate() / ( CLKDiv * (400 * 1000));
		CLKDiv ++;
		if(CLKDiv > 0x10000) return;
	}while((scl < 1) || (scl > 8));													
		
	Chip_I2CM_SetBusSpeed(((LPC_I2C_T *) (0x40050000UL)), 400);						
...
void Board_Clock_Init(void)
{
    ...
    Chip_SYSCTL_PowerUp((1 << 5));   								
	Chip_SYSCTL_PowerUp((1 << 7));   								
...
void Board_Init(void)
{
	...
	SysTick_Config(App.SysClock / 1000);								
