#line 1 "lpc_chip_82x\\src\\swm_8xx.c"
...
#line 33 "lpc_chip_82x\\src\\swm_8xx.c"
...
{
	uint32_t temp;
	int pinshift = (((movable) & 0xF) << 3), regIndex = (((movable) >> 4));

	temp = ((LPC_SWM_T *) (0x4000C000UL))->PINASSIGN[regIndex] & (~(0xFF << pinshift));
	((LPC_SWM_T *) (0x4000C000UL))->PINASSIGN[regIndex] = temp | (pin << pinshift);
}
