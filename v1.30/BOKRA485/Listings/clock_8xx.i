...
#line 33 "lpc_chip_82x\\src\\clock_8xx.c"
...
void Chip_Clock_SetSystemPLLSource(CHIP_SYSCTL_PLLCLKSRC_T src)
{
	((LPC_SYSCTL_T *) (0x40048000UL))->SYSPLLCLKSEL  = (uint32_t) src;
    
     
	((LPC_SYSCTL_T *) (0x40048000UL))->SYSPLLCLKUEN  = 0;  
	((LPC_SYSCTL_T *) (0x40048000UL))->SYSPLLCLKUEN  = 1;  
}
...
void Chip_Clock_SetPLLBypass(_Bool bypass, _Bool highfr)
{
	...
	((LPC_SYSCTL_T *) (0x40048000UL))->SYSOSCCTRL = ctrl;
}

 
void Chip_Clock_SetMainClockSource(CHIP_SYSCTL_MAINCLKSRC_T src)
{
	((LPC_SYSCTL_T *) (0x40048000UL))->MAINCLKSEL  = (uint32_t) src;
    
     
	((LPC_SYSCTL_T *) (0x40048000UL))->MAINCLKUEN  = 0;
	((LPC_SYSCTL_T *) (0x40048000UL))->MAINCLKUEN  = 1;
}

 
void Chip_Clock_SetCLKOUTSource(CHIP_SYSCTL_CLKOUTSRC_T src, uint32_t div)
{
	((LPC_SYSCTL_T *) (0x40048000UL))->CLKOUTSEL = (uint32_t) src;
    
     
	((LPC_SYSCTL_T *) (0x40048000UL))->CLKOUTUEN = 0;
	((LPC_SYSCTL_T *) (0x40048000UL))->CLKOUTUEN = 1;
	((LPC_SYSCTL_T *) (0x40048000UL))->CLKOUTDIV = div;
}

 
uint32_t Chip_Clock_GetWDTOSCRate(void)
{
	return Chip_Clock_GetWDTLFORate(((LPC_SYSCTL_T *) (0x40048000UL))->WDTOSCCTRL & ~(~0x1ff));
}
...
uint32_t Chip_Clock_GetSystemPLLInClockRate(void)
{
	...
	switch ((CHIP_SYSCTL_PLLCLKSRC_T) (((LPC_SYSCTL_T *) (0x40048000UL))->SYSPLLCLKSEL & 0x3)) {
...
uint32_t Chip_Clock_GetSystemPLLOutClockRate(void)
{
	return Chip_Clock_GetPLLFreq((((LPC_SYSCTL_T *) (0x40048000UL))->SYSPLLCTRL & ~(~0x7f)),
...
uint32_t Chip_Clock_GetMainClockRate(void)
{
	...
	switch ((CHIP_SYSCTL_MAINCLKSRC_T) (((LPC_SYSCTL_T *) (0x40048000UL))->MAINCLKSEL & 0x3)) {
...
uint32_t Chip_Clock_GetSystemClockRate(void)
{
	...
	return Chip_Clock_GetMainClockRate() / (((LPC_SYSCTL_T *) (0x40048000UL))->SYSAHBCLKDIV & ~(~0xff));
}
...
uint32_t Chip_Clock_GetIOCONCLKDIVClockRate(CHIP_PIN_CLKDIV_T reg)
{
	uint32_t div = ((LPC_SYSCTL_T *) (0x40048000UL))->IOCONCLKDIV[reg] & ~(~0xff);
...
void Chip_Clock_SetIOCONCLKDIV(CHIP_PIN_CLKDIV_T reg, uint8_t div)
{
	...
	((LPC_SYSCTL_T *) (0x40048000UL))->IOCONCLKDIV[t_reg] = div;
}
