...
#line 33 "lpc_chip_82x\\src\\i2cm_8xx.c"
...
uint32_t Chip_I2CM_XferHandler(LPC_I2C_T *pI2C, I2CM_XFER_T *xfer)
{
	...
	if (status & (1 << 4)) {
		...
		Chip_I2CM_ClearStatus(pI2C, (1 << 4));
		Chip_I2C_DisableInt(pI2C, 4294967295u);
	}
		...
		Chip_I2CM_ClearStatus(pI2C, (1 << 6));
		Chip_I2C_DisableInt(pI2C, 4294967295u);
	}
...
void Chip_I2CM_Xfer(LPC_I2C_T *pI2C, I2CM_XFER_T *xfer)
{
	...
	Chip_I2CM_ClearStatus(pI2C, (1 << 4) | (1 << 6));
