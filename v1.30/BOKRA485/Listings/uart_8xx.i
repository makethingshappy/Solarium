...
#line 33 "lpc_chip_82x\\src\\uart_8xx.c"
...
{
	if (pUART == ((LPC_USART_T *) (0x40064000UL))) {
		return SYSCTL_CLOCK_UART0;
	}
	else if (pUART == ((LPC_USART_T *) (0x40068000UL))) {
...
int Chip_UART_Send(LPC_USART_T *pUART, const void *data, int numBytes)
{
	...
	while ((sent < numBytes) &&
		   ((Chip_UART_GetStatus(pUART) & (0x01 << 2)) != 0)) {
...
int Chip_UART_Read(LPC_USART_T *pUART, void *data, int numBytes)
{
	...
	while ((readBytes < numBytes) &&
		   ((Chip_UART_GetStatus(pUART) & (0x01 << 0)) != 0)) {
...
void Chip_UART_RXIntHandlerRB(LPC_USART_T *pUART, RINGBUFF_T *pRB)
{
	...
	while ((Chip_UART_GetStatus(pUART) & (0x01 << 0)) != 0) {
...
void Chip_UART_TXIntHandlerRB(LPC_USART_T *pUART, RINGBUFF_T *pRB)
{
	...
	while (((Chip_UART_GetStatus(pUART) & (0x01 << 2)) != 0) &&
...
uint32_t Chip_UART_SendRB(LPC_USART_T *pUART, RINGBUFF_T *pRB, const void *data, int count)
{
	...
	Chip_UART_IntDisable(pUART, (0x01 << 2));
	...
	Chip_UART_IntEnable(pUART, (0x01 << 2));
...
void Chip_UART_IRQRBHandler(LPC_USART_T *pUART, RINGBUFF_T *pRXRB, RINGBUFF_T *pTXRB)
{
	...
	if ((Chip_UART_GetStatus(pUART) & (0x01 << 2)) != 0) {
