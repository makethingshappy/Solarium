...
#line 33 "lpc_chip_82x\\src\\syscon_8xx.c"
...
void Chip_SYSCTL_SetDeepSleepPD(uint32_t sleepmask)
{
	...
	((LPC_SYSCTL_T *) (0x40048000UL))->PDSLEEPCFG = (0x0000FFB7) | (sleepmask & (0x00000048));
}
...
void Chip_SYSCTL_SetWakeup(uint32_t wakeupmask)
{
	...
	((LPC_SYSCTL_T *) (0x40048000UL))->PDAWAKECFG = (0x00006D00) | (wakeupmask & (0x000080FF));
}
...
void Chip_SYSCTL_PowerDown(uint32_t powerdownmask)
{
	...
	pdrun = ((LPC_SYSCTL_T *) (0x40048000UL))->PDRUNCFG & (0x000080FF);

	 
	pdrun |= (powerdownmask & (0x000080FF));

	 
	((LPC_SYSCTL_T *) (0x40048000UL))->PDRUNCFG = ((0x00006D00) | pdrun);
}
