...
#line 50 "project.h"
#line 1 ".\\lpc_chip_82x\\inc\\stopwatch.h"
...
#line 36 ".\\lpc_chip_82x\\inc\\stopwatch.h"
...
static __inline uint32_t StopWatch_Elapsed(uint32_t startTime)
{
...
static __inline void StopWatch_DelayTicks(uint32_t ticks)
{
...
static __inline void StopWatch_DelayMs(uint32_t mS)
{
...
static __inline void StopWatch_DelayUs(uint32_t uS)
{
...
#line 1 "Hardware/brd_BOKRA_LPC824_Lite.h"
...
static inline void Board_MCU_Pin_Init(void)
{
	...
	Chip_GPIO_SetPinState(((LPC_GPIO_T *) (0xA0000000UL)), 0, 4, 1);									
	Chip_SWM_MovablePinAssign( SWM_U0_TXD_O, 4);									
	
	Chip_GPIO_SetPinState(((LPC_GPIO_T *) (0xA0000000UL)), 0, 0, 1);									
	Chip_SWM_MovablePinAssign( SWM_U0_RXD_I, 0);									
	Chip_IOCON_PinSetMode(((LPC_IOCON_T *) (0x40044000UL)), (CHIP_PINx_T) IOCON_PIO0, PIN_MODE_PULLUP);				
	
	
	Chip_GPIO_SetPinState(((LPC_GPIO_T *) (0xA0000000UL)), 0, 2, 1);									
	Chip_SWM_FixedPinEnable( SWM_FIXED_SWDIO, 1);								
	
	Chip_GPIO_SetPinState(((LPC_GPIO_T *) (0xA0000000UL)), 0, 3, 1);									
	Chip_SWM_FixedPinEnable( SWM_FIXED_SWCLK, 1);								

	
	Chip_GPIO_SetPinState(((LPC_GPIO_T *) (0xA0000000UL)), 0, 5, 1);									
	Chip_SWM_FixedPinEnable( SWM_FIXED_RST, 1);									
	
	Chip_GPIO_SetPinState(((LPC_GPIO_T *) (0xA0000000UL)), 0, 8, 1);									
	Chip_SWM_FixedPinEnable( SWM_FIXED_XTALIN, 1);								
	Chip_IOCON_PinSetMode( ((LPC_IOCON_T *) (0x40044000UL)), IOCON_PIO8, PIN_MODE_INACTIVE);
	
	
	Chip_GPIO_SetPinState(((LPC_GPIO_T *) (0xA0000000UL)), 0, 9, 1);									
	Chip_SWM_FixedPinEnable( SWM_FIXED_XTALOUT, 1);								
	Chip_IOCON_PinSetMode( ((LPC_IOCON_T *) (0x40044000UL)), IOCON_PIO9, PIN_MODE_INACTIVE);

	
	Chip_GPIO_SetPinState(((LPC_GPIO_T *) (0xA0000000UL)), 0, 11, 1);									
	Chip_SWM_FixedPinEnable( SWM_FIXED_I2C0_SDA, 1);								
	Chip_IOCON_PinSetI2CMode(((LPC_IOCON_T *) (0x40044000UL)), (CHIP_PINx_T) IOCON_PIO11, PIN_I2CMODE_STDFAST);		
	
	
	Chip_GPIO_SetPinState(((LPC_GPIO_T *) (0xA0000000UL)), 0, 10, 1);									
	Chip_SWM_FixedPinEnable( SWM_FIXED_I2C0_SCL, 1);								
	Chip_IOCON_PinSetI2CMode(((LPC_IOCON_T *) (0x40044000UL)), (CHIP_PINx_T) IOCON_PIO10, PIN_I2CMODE_STDFAST);		

	
	Chip_GPIO_SetPinState(((LPC_GPIO_T *) (0xA0000000UL)), 0, 19, 0);				
	Chip_GPIO_SetPinDIR( ((LPC_GPIO_T *) (0xA0000000UL)), 0, 19, 1);		
	Chip_IOCON_PinSetOpenDrainMode(((LPC_IOCON_T *) (0x40044000UL)), (CHIP_PINx_T) IOCON_PIO19, 1); 	
	
	
	Chip_GPIO_SetPinState(((LPC_GPIO_T *) (0xA0000000UL)), 0, 18, 0);				
	Chip_GPIO_SetPinDIR( ((LPC_GPIO_T *) (0xA0000000UL)), 0, 18, 1);		
	Chip_IOCON_PinSetOpenDrainMode(((LPC_IOCON_T *) (0x40044000UL)), (CHIP_PINx_T) IOCON_PIO18, 1);	
...
typedef struct AppStruct
{
	...
	RINGBUFF_T 							UART_rxRing;								
	RINGBUFF_T 							UART_txRing;								
	uint8_t								RxCMD[11];					
	uint8_t								RxCMDLen;									
	...
	uint16_t							Alive_CountDown;							
	uint16_t							GreenLed_Alive_Count;						
	uint16_t							YellowLed_Alive_Count;						
	_Bool								YellowLed_Off;								
	_Bool								GreenLed_Off;								
	
	volatile	_Bool					Second_Flag;								
	volatile	_Bool					ScanLogic_Flag;								
} App_t;
...
static uint8_t rxbuff[64], txbuff[64];					
static I2CM_XFER_T 						I2CXfer;									
...
{
	while ((xferRec->status == 0xFF) || (xferRec->txSz) || (xferRec->rxSz))	
	{}
}
...
void MCP23008_Write8(uint8_t RegAdr, uint8_t RegValue)
{
	...
	I2CXfer.slaveAddr = (0xfe & (0x40 | 0x04)) >> 1;									
	tmpTxBuff[0] = RegAdr;															
	tmpTxBuff[1] = RegValue;														
	I2CXfer.txBuff = &tmpTxBuff[0];													
	I2CXfer.txSz = 2;																
	I2CXfer.rxSz = 0;																
	I2CXfer.status = 0;
	
	Chip_I2CM_Disable(((LPC_I2C_T *) (0x40050000UL)));
	Chip_I2CM_Enable(((LPC_I2C_T *) (0x40050000UL)));	
	Chip_I2CM_Xfer(((LPC_I2C_T *) (0x40050000UL)), &I2CXfer);
	Chip_I2C_EnableInt(((LPC_I2C_T *) (0x40050000UL)), (1 << 0) | (1 << 4) | (1 << 6) | (1 << 24));
	WaitForI2cXferComplete(&I2CXfer);
	StopWatch_DelayTicks(100);
	Chip_I2C_DisableInt(((LPC_I2C_T *) (0x40050000UL)), (1 << 0) | (1 << 4) | (1 << 6) | (1 << 24));
...
void MCP23008_Init(void)
{
	...
	MCP23008_Write8 (0x05, 0x20);								
	MCP23008_Write8 (0x00, 0x03);								
	MCP23008_Write8 (0x01, 0x00);								
	MCP23008_Write8 (0x02, 0x00);							
	MCP23008_Write8 (0x03, 0x00);							
	MCP23008_Write8 (0x04, 0x00);							
	MCP23008_Write8 (0x06, 0x00);								
	MCP23008_Write8 (0x08, 0x00);							
	MCP23008_Write8 (0x09, 0x00);								
	MCP23008_Write8 (0x0A, 0x00);								
}
...
{
	uint8_t tmpInp = MCP23008_Read8(0x09) & 0x0f;				
...
void Decode_RxCMD(void)
{
	...
	rxCMD = strtok((char *) &App.RxCMD[0]," ,\0");									
	rxChannel = strtok( 0, " ,\0");												
	rxParm = strtok( 0, " ,\0");													
	Channel = strtoul(rxChannel, &p, 10);											
	Parm = strtoul(rxParm, &p, 10);													
	
	
	
	if(strncmp((char *) rxCMD, "ON", strlen("ON")) == 0)							
	{
		
		
		
		if((strlen(rxCMD) == strlen("ON")) || ((Parm < 999) && (Parm >= 1)))
		{
			Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, (const void*) & "RSP ", strlen("RSP "));	
			olen = sprintf( &tmpBuff[0], "%02d", Channel);							
			Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, tmpBuff, olen);	
		
			
			if((Channel >= 99) || 			(App.Logic[Channel].Enabled == 0)) Response = 2;					

			else																	
			{
				if(App.Logic[Channel].Output)										
				{	
					Response = 1;													
				}
				else
				{	
					App.Logic[Channel].PresetTime = Parm;							
					App.Logic[Channel].RemoteEnable = 1;							
					Response = 0;													
				}
			}
			
			olen = sprintf( &tmpBuff[0], ",%1d", Response);							
			Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, tmpBuff, olen);	
			Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, &(uint8_t *) {0x00}, 1);	
		}
		memset(&App.RxCMD[0],0x00, 11);								
		return;
	}

	
	
	if(strncmp((char *) rxCMD, "OFF", strlen("OFF")) == 0)							
	{
		...
		if(strlen(rxCMD) == strlen("OFF"))
		{
			...
			{
				if(App.Logic[Channel].RemoteEnable)									
				{	
					App.Logic[Channel].RemoteEnable = 0;						
	...
	if(strncmp((char *) rxCMD, "ASK", strlen("ASK")) == 0)							
	{
		
		
		if(strlen(rxCMD) == strlen("ASK"))
		{
			App.Alive_CountDown = 30;									
			
			Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, (const void*) & "SOK", strlen("SOK"));
			Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, &(uint8_t *) {0x00}, 1);	
		}
		memset(&App.RxCMD[0],0x00, 11);								
		return;
	...
	if(strncmp((char *) rxCMD, "ADI", strlen("ADI")) == 0)							
	{
		
		
		if(strlen(rxCMD) == strlen("ADI"))
		{
			Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, (const void*) & "SDI ", strlen("SDI "));	
			olen = sprintf( &tmpBuff[0], "%02d", Channel);							
			Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, tmpBuff, olen);	
			...
			{
				Response = App.Logic[Channel].Input;								
			}
	...
	if(strncmp((char *) rxCMD, "ADO", strlen("ADO")) == 0)							
	{
		
		
		if(strlen(rxCMD) == strlen("ADO"))
		{
			Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, (const void*) & "SDO ", strlen("SDO "));	
			olen = sprintf( &tmpBuff[0], "%02d", Channel);							
			Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, tmpBuff, olen);	
			...
			{
				Response = App.Logic[Channel].Output;								
				if(App.Logic[Channel].PresetTime) App.Alive_CountDown = 30;	
			}
	...
	if(strncmp((char *) rxCMD, "SRT", strlen("SRT")) == 0)							
	{
		
		
		if(strlen(rxCMD) == strlen("SRT"))
		{
			Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, (const void*) & "TIM ", strlen("TIM "));	
			olen = sprintf( &tmpBuff[0], "%02d", Channel);							
			Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, tmpBuff, olen);	
		
			
			if((Channel >= 99) || 			(App.Logic[Channel].Enabled == 0)) Response = 0;					

			else																	
			{
				Response = (App.Logic[Channel].OnTime/(1000/10));
				if(App.Logic[Channel].Output == 0) App.Logic[Channel].OnTime = 0;	
			}
			
			olen = sprintf( &tmpBuff[0], ",%03d", Response);						
			Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, tmpBuff, olen);	
			Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, &(uint8_t *) {0x00}, 1);	
		}
		memset(&App.RxCMD[0],0x00, 11);								
	...
	memset(&App.RxCMD[0],0x00, 11);									
	Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, (const void*) & "ERR 01", strlen("ERR 01"));	
	Chip_UART_SendRB( ((LPC_USART_T *) (0x40064000UL)), &App.UART_txRing, &(uint8_t *) {0x00}, 1);	
}
...
void App_Init(void)
{
	memset(&App.Logic[0], 0x00, sizeof(App.Logic[0]) * 99);	
	App.Logic[1].Enabled = 1;													
	App.Logic[2].Enabled = 1;													
	App.Alive_CountDown = 30;											
	App.Write_Output =  1;														
...
{
	App.TickCount += 1;																
	if((App.TickCount % 1000) == 0) App.Second_Flag = 1;			
	if((App.TickCount % 10) == 1) App.ScanLogic_Flag = 1;	
	
	if(App.GreenLed_Alive_Count) App.GreenLed_Alive_Count --;						
	else App.GreenLed_Off = 1;

	if(App.YellowLed_Alive_Count) App.YellowLed_Alive_Count --;						
	else App.YellowLed_Off = 1;
}
...
{
	Chip_UART_IRQRBHandler(((LPC_USART_T *) (0x40064000UL)), &App.UART_rxRing, &App.UART_txRing);			
	{App . GreenLed_Alive_Count = 100; Chip_GPIO_WritePortBit( ((LPC_GPIO_T *) (0xA0000000UL)), 0, 19, 1 );};																
}
...
{
	Chip_I2CM_XferHandler(((LPC_I2C_T *) (0x40050000UL)), &I2CXfer); 										
}
...
int main(void)
{
	...
	Board_Init();																	
	Chip_GPIO_WritePortBit( ((LPC_GPIO_T *) (0xA0000000UL)), 0, 19, 0 );		
	Chip_GPIO_WritePortBit( ((LPC_GPIO_T *) (0xA0000000UL)), 0, 18, 0 );		

	
	RingBuffer_Init(&App.UART_rxRing, rxbuff, 1, 64);					
	RingBuffer_Init(&App.UART_txRing, txbuff, 1, 64);					
	...
	Chip_GPIO_WritePortBit( ((LPC_GPIO_T *) (0xA0000000UL)), 0, 19, 1 );		
	StopWatch_DelayMs(500);															
	...
	Chip_UART_IntEnable(((LPC_USART_T *) (0x40064000UL)), (0x01 << 0));						
	Chip_UART_IntDisable(((LPC_USART_T *) (0x40064000UL)), (0x01 << 2));						
	...
	while (1) 
	{
		...
		if(RingBuffer_GetCount(&App.UART_rxRing))									
		{
			uint8_t rxchar;
			RingBuffer_Pop(&App.UART_rxRing, &rxchar);								
			if(rxchar == 0x00)											
			{
				{App . YellowLed_Alive_Count = 100; Chip_GPIO_WritePortBit( ((LPC_GPIO_T *) (0xA0000000UL)), 0, 18, 1 );};													
				Decode_RxCMD();														
				App.RxCMDLen = 0;													
			}
			else if(App.RxCMDLen <= 11) App.RxCMD[App.RxCMDLen++] = toupper(rxchar);
		}	
		...
		{
			App.ScanLogic_Flag = 0;												
		
			for(Chnl = 0; Chnl < 99; Chnl ++)					
			{
				if(App.Logic[Chnl].Input)											
				{	
					
					if((App.Logic[Chnl].PresetTime) && (App.Logic[Chnl].Output == 0) && (App.Alive_CountDown) && (App.Logic[Chnl].RemoteEnable))
					{
						App.Logic[Chnl].OnTime = 0;									
						App.Logic[Chnl].Output = 1;									
						App.Write_Output = 1;									
					}
				}
				else																
				{
					...
					if((App.Logic[Chnl].PresetTime) && (App.Logic[Chnl].Output))	
					{
						App.Logic[Chnl].Output = 0;									
						App.Logic[Chnl].PresetTime = 0;								
						App.Logic[Chnl].RemoteEnable = 0;						
						App.Write_Output = 1;									
					}
				}

				
				if(App.Logic[Chnl].OnTime == (App.Logic[Chnl].PresetTime*(1000/10)))
				{
					App.Logic[Chnl].Output = 0;										
					App.Logic[Chnl].PresetTime = 0;									
					App.Logic[Chnl].RemoteEnable = 0;							
				...
				else App.Logic[Chnl].OnTime += App.Logic[Chnl].Output;				

				
				
				if(App.Logic[Chnl].RemoteEnable == 0)							
				{
					App.Logic[Chnl].Output = 0;										
					App.Logic[Chnl].PresetTime = 0;									
					App.Logic[Chnl].RemoteEnable = 0;							
		...
		if(App.Second_Flag)
		{
			...
			if(App.Alive_CountDown) App.Alive_CountDown--;							
			App.Second_Flag = 0;
	
			
		}

		if(App.GreenLed_Off) {Chip_GPIO_WritePortBit( ((LPC_GPIO_T *) (0xA0000000UL)), 0, 19, 0 ); App . GreenLed_Off = 0;};
		if(App.YellowLed_Off) {Chip_GPIO_WritePortBit( ((LPC_GPIO_T *) (0xA0000000UL)), 0, 18, 0 ); App . YellowLed_Off = 0;};
